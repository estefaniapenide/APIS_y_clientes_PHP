...
<?php endif;?> 
<div class="container">
  <h1 class="title">Consultar ventas por cliente</h1>
  <h2 class="subtitle">
    Consulta las ventas por cliente en un determinado intervalo de tiempo</h2>

<form action="<?= base_url(route_to('consultarPorCliente'))?>" method="POST">
    <div class="field">
