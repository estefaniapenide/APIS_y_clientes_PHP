...
class Ventas extends BaseController
{
    ...
    public function consultarVentas()
    {
        ...
        try{
            ...
            if($data['id']==null){
                $response = $client->request('GET', 'http://apis.test/APIv3/ventas/TodasVentas',$options);
                ...
                $response = $client->request('GET', 'http://apis.test/APIv3/ventas/ventasBy/ventas_id/'.$data['id'],$options);
                $ventas= (array) json_decode($response->getBody());
            }
     ...
     public function consultarPorEmpresa()
    {
      ...
      try{ 
        ...
        if(!($data['from']==null && $data['to']==null)){      
            if($data['from']==null){
                $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorEmpresa',['form_params' => ['to'=>$data['to']]]);
            }elseif($data['to']==null){
                $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorEmpresa',['form_params' => ['from'=>$data['from']]]);
            }else{
                $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorEmpresa',['form_params' => $data]);
            }
        }else{
            $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorEmpresa');
        }
    ...
    public function consultarPorFabrica()
    {
        ...
        try{ 
            ...
            $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorFabrica',['json' => $data]);
            $ventas= (array) json_decode($response->getBody());
    ...
    public function consultarPorCentro()
    {
        ...
        try{ 
            ...
            $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorCentro',['json' => ['from'=>(int)$data['from'],'to'=>(int)$data['to']]]);
            $ventas= (array) json_decode($response->getBody());
    ...
    public function consultarPorCliente()
    {
        ...
        try{ 
            ...
            //El método de la API sólo acepta ints o valores vacíos., por lo que hay que convertir los datos a ints.
            //Es imprescindible hacer una validación previa porque al hacer el casting así, si son strings los convertirá a cero.
            $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorCliente',['json' => ['from'=>(int)$data['from'],'to'=>(int)$data['to']]]);
            $ventas= (array) json_decode($response->getBody());
    ...
    public function consultarPorMaterial()
    {
        ...
        try{ 
            ...
            //El método de la API sólo acepta ints o valores vacíos., por lo que hay que convertir los datos a ints.
            //Es imprescindible hacer una validación previa porque al hacer el casting así, si son strings los convertirá a cero.
            $response = $client->request('POST', 'http://apis.test/APIv3/ventas/ventasPorMaterial',['json' => ['from'=>(int)$data['from'],'to'=>(int)$data['to']]]);
            $ventas= (array) json_decode($response->getBody());
    ...
    public function modificarCantidad()
    {
        ...
        try{
                ...
                $response = $client->request('PUT', 'http://apis.test/APIv3/ventas/modificarCantidadVenta/'.(int)$data['id'],['json' => ['ventas_cantidad' => (int)$data['cantidad']]]);
    ...
    public function eliminarRegistro()
    {
      ...
      $validation = service('validation');
       ...
       try{
            ...
            //Tanto el id como la cantidad es requerido en la API que sean ints, por lo que al hacer el casting así, si son strings los convertirá a cero,
            //por lo que es imprescindible la validación anterior.
            $response = $client->request('DELETE', 'http://apis.test/APIv3/ventas/eliminarRegistroVenta/'.(int)$data['id']);
