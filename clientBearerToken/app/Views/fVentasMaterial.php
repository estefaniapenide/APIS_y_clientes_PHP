...
<?php endif;?> 
<div class="container">
  <h1 class="title">Consultar ventas por material</h1>
  <h2 class="subtitle">
    Consulta las ventas por material en un determinado intervalo de tiempo</h2>

<form action="<?= base_url(route_to('consultarPorMaterial'))?>" method="POST">
    <div class="field">
